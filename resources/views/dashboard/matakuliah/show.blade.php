                    ...
                    <div class="row" style="display: inline-block;">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <a href="{{ url('tambah-mahasiswa/'.$id) }}" class="btn btn-sm btn-primary ">Tambah Mahasiswa</a>
                            </div>
                            <div class="card-body">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        @if($mahasiswa['matakuliah_id'] == $id)
                                        <tr>
                                            <td>{{ $i++ }}</td>
                                            <td>{{ $mahasiswa->nama }}</td>
                                            <td>{{ $mahasiswa->nim }}</td>
                                            <td><a href="{{ url('mengubah-mahasiswa/') }}/{{ $mahasiswa->id }}" class="btn btn-sm btn-success">Edit</a></td>
                                            <td><a href="{{ url('hancurkan-mahasiswa/'.$mahasiswa->id) }}/{{ $id }}" class="btn btn-sm btn-danger">Delete</a></td>
                                        </tr>
                                        @endif
                                        @endforeach
                                    </tbody>
