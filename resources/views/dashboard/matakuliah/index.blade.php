                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php
                                                $con = mysqli_connect('localhost', 'root', '', 'tugas-skripsi');
                                                $relasi_models = mysqli_query($con, "SELECT * FROM relasi_models JOIN dosens ON relasi_models.dosen_id = dosens.id WHERE matakuliah_id = '$mata_kuliah[uuid]'") or die(mysqli_error($con));
                                                while ($matakuliah_uuid = mysqli_fetch_array($relasi_models)) {
                                                    echo $matakuliah_uuid['nama'] . "<br>";
                                                }
                                                ?>
                                            </td>
