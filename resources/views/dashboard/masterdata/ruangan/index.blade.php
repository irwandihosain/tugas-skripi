                    ...
                    <div class="row" style="display: inline-block;">
                        <div class="card">
                            <div class="card-header">
                                <a href="{{ url('tambah-ruangan') }}" class="btn btn-sm btn-primary ">Tambah Ruangan</a>
                            </div>
                            <div class="card-body">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        $i = 1
                                        @endphp
                                        @foreach ($ruangann as $key => $ruangan)
                                        <tr>
                                            <td>{{ $i++ }}</td>
                                            <td>{{ $ruangan['nama'] }}</td>
                                            <td><a href="{{ url('edit-ruangan/'.$key) }}" class="btn btn-sm btn-success">Edit</a></td>
                                            <td><a href="{{ url('delete-ruangan/'.$ruangan->id) }}" class="btn btn-sm btn-danger">Delete</a></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
