                    ...
                    <div class="row" style="display: inline-block;">
                        <div class="card">
                            <div class="card-header">
                                <a href="{{ url('tambah-namaMatakuliah') }}" class="btn btn-sm btn-primary ">Tambah Nama Matakuliah</a>
                            </div>
                            <div class="card-body">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        $i = 1
                                        @endphp
                                        @foreach ($Matakuliahh as $key => $namaMatakuliah)
                                        <tr>
                                            <td>{{ $i++ }}</td>
                                            <td>{{ $namaMatakuliah['nama'] }}</td>
                                            <td><a href="{{ url('edit-namaMatakuliah/'.$key) }}" class="btn btn-sm btn-success">Edit</a></td>
                                            <td><a href="{{ url('/delete-namaMatakuliah/'.$namaMatakuliah->id) }}" class="btn btn-sm btn-danger">Delete</a></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
