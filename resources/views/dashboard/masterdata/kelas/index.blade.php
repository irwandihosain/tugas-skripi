                    ...
                    <div class="row" style="display: inline-block;">
                        <div class="card">
                            <div class="card-header">
                                <a href="/tambah-kelas" class="btn btn-sm btn-primary ">Tambah Kelas</a>
                            </div>
                            <div class="card-body">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ $i++ }}</td>
                                            <td>{{ $kelas['nama'] }}</td>
                                            <td><a href="/edit-kelas/" class="btn btn-sm btn-success">Edit</a></td>
                                            <td><a href="/delete-kelas/{{ $kelas->id }}" class="btn btn-sm btn-danger">Delete</a></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
