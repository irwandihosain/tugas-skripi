                    ...
                    <div class="row" style="display: inline-block;">
                        <div class="card">
                            <div class="card-header">
                                <a href="{{ url('tambah-fakultas') }}" class="btn btn-sm btn-primary ">Tambah Fakultas</a>
                            </div>
                            <div class="card-body">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ $i++ }}</td>
                                            <td>{{ $fakultas['nama'] }}</td>
                                            <td><a href="{{ url('edit-fakultas/') }}" class="btn btn-sm btn-success">Edit</a></td>
                                            <td><a href="{{ url('delete-fakultas/'.$fakultas->id) }}" class="btn btn-sm btn-danger">Delete</a></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
