                    ...
                    <div class="row" style="display: inline-block;">
                        <div class="card">
                            <div class="card-header">
                                <a href="{{ url('tambah-hari') }}" class="btn btn-sm btn-primary ">Tambah Hari</a>
                            </div>
                            <div class="card-body">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        $i = 1
                                        @endphp
                                        @foreach ($harii as $hari)
                                        <tr>
                                            <td>{{ $i++ }}</td>
                                            <td>{{ $hari['nama'] }}</td>
                                            <td><a href="{{ url('edit-hari/'.$hari->id) }}" class="btn btn-sm btn-success">Edit</a></td>
                                            <td><a href="/delete-hari/{{ $hari->id }}" class="btn btn-sm btn-danger">Delete</a></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
