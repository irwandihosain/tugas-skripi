                    ...
                    <div class="row" style="display: inline-block;">
                        <div class="card">
                            <div class="card-header">
                                <a href="{{ url('tambah-dosen') }}" class="btn btn-sm btn-primary ">Tambah Dosen</a>
                            </div>
                            <div class="card-body">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $dosen['nama'] }}</td>
                                            <td>{{ $dosen['email'] }}</td>
                                            <td><a href="{{ url('edit-dosen') }}" class="btn btn-sm btn-success">Edit</a></td>
                                            <td><a href="{{ url('delete-dosen') }}" class="btn btn-sm btn-danger">Delete</a></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
