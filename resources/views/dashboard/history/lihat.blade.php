                            ...
                            <div class="card-body">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        $i = 1;
                                        @endphp
                                        @if (is_array($pertemuanMahasiswas) || is_object($pertemuanMahasiswas))
                                        @foreach ($pertemuanMahasiswas as $key => $pertemuanMahasiswa)
                                        <tr>
                                            <td>{{ $i++ }}</td>
                                            <td>{{ $pertemuanMahasiswa['nim'] }}</td>
                                            <td>{{ $pertemuanMahasiswa['keterangan'] }}</td>
                                        </tr>
                                        @endforeach
                                        @else
                                        <tr>
