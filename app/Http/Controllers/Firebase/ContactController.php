...
class ContactController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($postRef) {
            ...
            return redirect('contacts')->with('status', 'Not added succesfully');
        }
    }
    public function edit($id)
    {
        ...
        if ($editdata) {
            ...
            return redirect('contacts')->with('status', 'Contact is Not Found');
        }
    }
    public function update(Request $request, $id)
    {
        ...
        if ($res_updated) {
            return redirect('contacts')->with('status', 'Cantact Updated Succesfully');
        } else {
            return redirect('contacts')->with('status', 'Cantact Not Updated');
        }
    }
    public function destroy($id)
    {
        ...
        if ($del_data) {
            return redirect('contacts')->with('status', 'Cantact Deleted Succesfully');
        } else {
            return redirect('contacts')->with('status', 'Cantact Not Deleted');
        }
    }
}
